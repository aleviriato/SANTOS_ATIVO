CREATE OR REPLACE PACKAGE "PAC_CALCULA_TEMPO_ATIVO" as
...
/
CREATE OR REPLACE PACKAGE BODY "PAC_CALCULA_TEMPO_ATIVO" as
...
SELECT COD_IDE_CLI,
 ...
 --
  PROCEDURE SP_CALC_ANOS_TRAB_ATIVO(
    ...
    SEQ_CERTIDAO NUMBER;
  BEGIN
    -- Carrega Variaveis para Calculo de Tempo ----
    -----------------------------------------------
             ...
             insert into TB_CONTAGEM_LICENCA_AQUISITIVO
              (ID,
               ...
               (SEQ_CONTAGEM_LIC_AQUISITIVO.nextval, --ID,
                ...
                r.DATA_CALCULO,     --DAT_FIM,
                90,                 --NUM_DIAS_DIREITO,
                sysdate,            --DAT_ING,
                sysdate,            --DAT_ULT_ATU,
                user,               --NOM_USU_ULT_ATU,
                'PAC_CALCULA_TEMPO_ATIVO',--NOM_PRO_ULT_ATU,
                null);                --FLG_AVERBADO
          end if;
          v_qtd_bruto := 0;
